      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          className={cn(
            ...
            isMobile &&
              "absolute inset-y-0 left-0 z-20 h-[calc(100%-4rem)] mt-16",
        ...
        >
          ...
          {!arenaMode ? (
            ...
            <>
              ...
              <MessageInput arenaMode={arenaMode} />{" "}
              {/* Pass arenaMode to MessageInput */}
            </>
          ) : (
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="border-t">
                <MessageInput arenaMode={arenaMode} />{" "}
                {/* Pass arenaMode to MessageInput in arena mode */}
              </div>
            </div>
          )}
